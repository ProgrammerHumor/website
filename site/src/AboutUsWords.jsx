      ...
      <div className="forAboutUsBottomHalfOfPage">
        ...
        <div className="forAboutUsPara">
          <Header color="grey" size="medium">
            This will be where you can say what the page is all about and stuff
            or whatever this can be deleted its just my first idea. Mabey we can
            do someting else I dont know, but whatever just keep swiming swiming
            swiming.
          </Header>
        </div>
      </div>
