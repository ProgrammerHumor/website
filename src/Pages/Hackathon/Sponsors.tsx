...
import reddit from "../../images/Sponsors/reddit.svg";
  ...
  render = () => (
    <div id="Sponsors">
      <div>
        ...
        <Grid verticalAlign="middle" stackable columns="9">
          <Grid.Row>
            <Grid.Column/>
            <Grid.Column/>
            <Grid.Column/>
            ...
            <Grid.Column>
              <Image href="https://www.reddit.com/" src={reddit} size="small" centered/>
            </Grid.Column>
          </Grid.Row>
        </Grid>
        </Responsive>
        ...
        <Grid verticalAlign="middle" stackable columns="equal">
          <Grid.Row>
              ...
              <Image href="https://www.reddit.com/" src={reddit} size="tiny" centered/>
          </Grid.Row>
        </Grid>
        </Responsive>
      </div>
